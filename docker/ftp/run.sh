...
# Add mock users
FTP_PASSWORD_1="$(< docker/.secrets/ftp_camera-1_password)"
DOCKER_ENV_PARAMS+=( -e "FTP_USER_1=camera-1" -e "FTP_PASSWORD_1=${FTP_PASSWORD_1}" )

FTP_PASSWORD_2="$(< docker/.secrets/ftp_camera-2_password)"
DOCKER_ENV_PARAMS+=( -e "FTP_USER_2=camera-2" -e "FTP_PASSWORD_2=${FTP_PASSWORD_2}" )
